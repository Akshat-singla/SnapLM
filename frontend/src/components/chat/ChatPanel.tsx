...
import {
    ...
    History, Bot, CornerUpLeft, ImagePlus, XCircle
} from 'lucide-react';
...
const ChatPanel = () => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (capturedImage) {
                response = await nodesApi.sendVisionMessage(node.id, userMsg.content === '(image)' ? 'Describe this image.' : userMsg.content, capturedImage);
            } else {
                    ...
                    <div className="p-4 bg-white dark:bg-[#151a23] border-t border-gray-200 dark:border-[#282e39]">
                        ...
                        {imagePreview && (
                            <div className="relative inline-block mb-2 ml-1">
                                <img src={imagePreview} alt="preview" className="h-16 w-16 object-cover rounded-lg border border-gray-200 dark:border-[#282e39]" />
                                <button
                                    onClick={clearImage}
