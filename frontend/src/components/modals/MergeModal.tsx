  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-black/70 backdrop-blur-md z-[100]">
      <div className="bg-surface-dark w-full max-w-md rounded-2xl shadow-2xl border border-white/10 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-6 p-4 bg-background-dark rounded-xl border border-white/10">
            <div className="flex-1 text-center">
              <span className="text-xs text-slate-500 block mb-1">From</span>
              <span className="text-sm font-bold text-white block truncate max-w-[100px] mx-auto">{node.data.title}</span>
            </div>
            ...
            <div className="flex-1 text-center">
              ...
              <select
                className="w-full bg-surface-dark border border-white/10 rounded px-2 py-1 text-xs font-bold text-white truncate focus:outline-none focus:ring-1 focus:ring-primary"
          ...
          <div className="mb-6">
            ...
            <textarea
              autoFocus
              className="w-full bg-transparent border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-merge-accent focus:ring-1 focus:ring-merge-accent transition-all resize-none h-24"
